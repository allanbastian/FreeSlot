...
public class ThursdayFrag extends android.support.v4.app.Fragment {
    private RecyclerView recyclerView;
    private FreeSlotRecycleAdapter adapter;

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.thursdayfrag, container, false);
        recyclerView = (RecyclerView) rootView.findViewById(R.id.thursday);
